...
public class MessageOrderListenerImpl3 implements MessageOrderListener {
    // private static final Logger logger = LoggerFactory.getLogger(MessageOrderListenerImpl3.class);
    private MongoCollection<Document> collection;

    public MessageOrderListenerImpl3() {
        initMongoCollection();
    }
