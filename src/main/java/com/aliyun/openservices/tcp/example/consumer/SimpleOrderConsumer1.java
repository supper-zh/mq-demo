...
public class SimpleOrderConsumer1 {
    ...
    public static void main(String[] args) {
        ...
        //     }
        // });
        MessageOrderListenerImpl1 messageOrderListenerImpl1 = new MessageOrderListenerImpl1();
        consumer.subscribe(MqConfig.ORDER_TOPIC, MqConfig.TAG,  messageOrderListenerImpl1);
        consumer.start();
